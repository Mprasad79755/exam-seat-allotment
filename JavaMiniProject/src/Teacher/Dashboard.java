...
//        setUndecorated(true); // Remove window borders and controls (optional)
        ...
        tabbedPane.addTab("Student List", new StudentList());
        tabbedPane.addTab("Exam Report", new ExamReport());
        tabbedPane.addTab("Exam TimeTable", new ExamListPanel());
        tabbedPane.addTab("Invigilation", new Invigilation());
